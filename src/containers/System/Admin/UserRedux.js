...
class UserRedux extends Component {
    ...
    render() {
        ...
        let isGetGenders = this.props.isLoadingGenderReact
                        ...
                        <div className="row">
                            ...
                            <div className="col-3">
                                ...
                                <div className="preview-img-container">
                                    <input id="previeweImg" type="file" hidden
                                        onChange={(event) => this.handleOnchangeImage(event)}
                                    />
                                    <label className="label-upload" htmlFor="previeweImg">Tải ảnh
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        // changeLangugeAppRedux: (language) => dispatch(actions.changeLanguageApp(language))
    };
};
